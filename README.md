...
3. Calculates how the fraction of residential buildings in all buildings regarding to floor area has developed over the last three years 2020, 2021 and 2022  
4. Does some ***very*** basic data visualization by scatterplotting build date, floor area and floor count attributes  
